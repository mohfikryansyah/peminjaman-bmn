    ...
    <div class="lg:h-[87vh] w-full relative">
        <div class="grid lg:grid-cols-4 grid-flow-row lg:gap-4 gap-2 w-full lg:absolute">
            <a
                ...
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $totalBarang->count() }}</h5>
        ...
        <p class="text-center text-2xl max-w-2xl">Jl. Rusli Datau No.10, Dulomo Sel., Kec. Kota Utara, Kota Gorontalo,
            Gorontalo 96128</p>
        </div>
    </div>
